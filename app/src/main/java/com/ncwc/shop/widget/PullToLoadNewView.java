...
import com.ncwc.shop.interactor.ScrollDirection;
import com.ncwc.shop.util.RecyclerViewPositionHelper;

/**
 * Created by DELL-PC on 2015/12/11.
 */
public class PullToLoadNewView extends FrameLayout {
	...
	public PullToLoadNewView(Context context) {
		this(context, null);
	}

	public PullToLoadNewView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PullToLoadNewView(Context context, AttributeSet attrs, int defStyleAttr) {
