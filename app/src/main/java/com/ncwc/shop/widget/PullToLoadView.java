...
public class PullToLoadView extends FrameLayout {
    ...
    public PullToLoadView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSwipeRefreshLayout.setColorSchemeResources(android.R.color.holo_red_light, android.R.color.holo_red_light, android.R.color.holo_red_light, android.R.color.holo_red_light);
