...
public class PullRefreshLayout extends ViewGroup {
	...
	private com.ncwc.shop.widgets.RefreshDrawable mRefreshDrawable;
	...
	public PullRefreshLayout(Context context, AttributeSet attrs) {
		...
		final int colorsId = a.getResourceId(R.styleable.PullRefreshLayout_colors, R.array.scheme_colors);
		a.recycle();
...
//        mRefreshDrawable.setColorSchemeColors(new int[]{Color.rgb(0xC9, 0x34, 0x37), Color.rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)});
	...
	public void setRefreshDrawable(com.ncwc.shop.widgets.RefreshDrawable drawable) {
		setRefreshing(false);
