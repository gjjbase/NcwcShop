...
public class RoundProgressBar extends ProgressBar {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.ActionBar);
		...
		textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize, 60);
